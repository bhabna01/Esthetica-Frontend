...
const Banner = () => {
    return (
        ...
        // </div>
        <div className="carousel w-full h-[600px] md:h-[500px] sm:h-[400px]">
            <div id="slide1" className="carousel-item relative w-full">
                <img
                    src={img1}
                    className="w-full rounded-xl" />
                <div className="rounded-xl absolute flex h-full left-0 bg-gradient-to-r from-black to-[rgba(21,21,21,0)] top-0 items-center">
                    <div className="text-white space-y-7 pl-8 sm:pl-4 md:pl-6 lg:pl-12 w-full md:w-1/2">
                        <h2 className="text-3xl sm:text-2xl md:text-4xl lg:text-6xl font-bold">Affordable prices for beauty Service</h2>
                        <p className="text-sm sm:text-xs md:text-base lg:text-lg">Elevate Your Beauty, Embrace Your Confidence – Experience Luxury with Every Service.</p>
                        <div>
                            <button className="btn btn-outline btn-primary mr-5">Discover Services</button>
                            <button className="btn btn-outline btn-secondary">Learn more</button>
                        </div>
